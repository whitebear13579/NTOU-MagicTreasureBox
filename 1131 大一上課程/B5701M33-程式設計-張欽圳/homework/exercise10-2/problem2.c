...
bool test = 0;
/*
when test = 1, call asctime()
otherwise, call AAsctime()
*/
...
int solve(){
    ...
    printf("%s\n%s%s\n",weekday[timeinfo.tm_wday],(test ? asctime(&timeinfo) : AAsctime(&timeinfo)),date);
    ...
    printf("%s\n%s%s\n",weekday[timeinfo2->tm_wday],(test ? asctime(timeinfo2) : AAsctime(timeinfo2)),date2);
    return 0;
}
